...
class IngestionPipeline:
    ...
    def run(
        ...
        try:
            ...
            _elapsed_transform = (time.perf_counter() - _t0_transform) * 1000.0
            if trace is not None:
            ...
            _elapsed_storage = (time.perf_counter() - _t0_storage) * 1000.0
            if trace is not None:
    ...
    def close(self) -> None:
        ...
        self.vector_upserter.vector_store.close()
