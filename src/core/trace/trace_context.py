...
class TraceContext:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # Keep enough precision for fast in-memory paths; rounding to two
            # decimals made a real positive duration indistinguishable from 0.
            "total_elapsed_ms": round(self.elapsed_ms(), 6),
