...
class BaseVectorStore(ABC):
    ...
    def close(self) -> None:
        ...
        Stateless providers may keep the default no-op. Persistent providers
        should override this method so callers can deterministically release
        database and index handles.
        """
