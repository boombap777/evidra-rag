...
def _optional_string(value: Any) -> Optional[str]:
    """Ignore unset dynamic-mock attributes and normalise configured strings."""
...
class OpenAIEmbedding(BaseEmbedding):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        azure_endpoint = _optional_string(getattr(settings.embedding, 'azure_endpoint', None))
        self.api_version = _optional_string(getattr(settings.embedding, 'api_version', None))
        ...
        if base_url:
            ...
            settings_base_url = _optional_string(getattr(settings.embedding, 'base_url', None))
